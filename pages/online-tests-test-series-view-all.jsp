...
<div class="content">
	<div class="container">
		<div class="banner">
			<h1 class="center">View test series</h1>
			<hr />
		</div>
		<br />
		<br />
		<div id="all-test-series"></div>
	</div><!-- .container -->
</div><!-- .content -->
...
<c:if test="${env == 'dev'}">
	...
	<script type="text/javascript" src="${hostName}assets/scripts/odin/view-test-series.js?v=${version}"></script>
</c:if>
