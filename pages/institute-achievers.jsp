...
<div id="content" class="content">
	<div class="container">
		<div class="banner">
			<h1 class="center">${inlineData.name} Achievers</h1>
			<hr />
		</div>
		<br />
		<p class="big center easy-nav">
			...
			<a href="team">Team</a>
			&nbsp;&nbsp;
			<a href="achievers" class="bold">Achievers</a>
			&nbsp;&nbsp;
		...
		<div id="hero" class="box tm-owner-hero inline-blk img-wrapper">
			...
			<a href="../institute/portfolio?edit=5" class="btn-double btn-edt-entity btn-edt-entity-1 upper white center js-non-owner">
		...
		<div class="js-txt-other" style="display: none">
			<br />
			<br />
			<p class="big center">Other achievers of ${inlineData.name}</p>
			<br />
		</div>
		<div id="reorder-container">
			<a href="#" id="save-order" class="btn-double upper white center js-non-owner" style="display: block; width: 130px; margin: 0 auto 20px auto" data-entity="achievers">
		...
		<div class="js-entity grid-row center entity-cntnr">
			<p class="mono bigger">No achievers yet</p>
		</div>
		<br />
		<br />
	</div>
